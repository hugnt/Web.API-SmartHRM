...
$(document).ready(async function () {
    var listData = await getList("/Bonus");
    ...
    async function getDetails() {
        var id = $(this).data("id");
        var selectedData = await getData(`/Bonus/${id}`);
    ...
    $("#btnAdd").click(async function () {
        ...
        myModal.hide();
        await postData("/Bonus", dataInsert);
        var listData = await getList("/Bonus");
    ...
    $("#btnSave").click(async function () {
        ...
        myModal.hide();
        await putData(`/Bonus/${updatedData.id}`, updatedData);
        var listData = await getList("/Bonus");
        newGrid.updateData(listData)
    });
    ...
    $("#delete-notification").click(async function () {
        ...
        await putStatus(`/Bonus/DeletedStatus/${id}/${true}`);
        var listData = await getList("/Bonus");
        newGrid.updateData(listData)
    });
    ...
    $("#btnFilter").click(async function () {
        ...
        var listData = await getList(`/Bonus/Search/${field}/${keyword}`);
        console.log(listData)
        newGrid.updateData(listData)
